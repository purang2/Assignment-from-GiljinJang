...
###
### PART 1.fashion-MNIST 데이터셋으로 본 가중치 초깃값
...
# 학습 데이터를 줄임
x_train = x_train[:1000]   #  (60000,784) -> (1000,784) just 상위 1000개 F-mnist data
t_train = t_train[:1000]   #  (60000,)    -> (1000,) just 상위 1000개 label
